    ...
    for (const entity of entities) {
      ...
      try {
        switch (entity.type.toUpperCase()) {
          ...
          case "HATCH":
            // console.log("HATCH detected", entity);
            curves.push({
              type: "HATCH",
...
//             curves.push({
//               type: "HATCH",
//               boundaryPaths: (entity.boundary.loops || []).map((path) => ({
//                 edges: (path.edges || []).map((edge) => ({
//                   type: edge.type,
//                   vertices: (edge.vertices || []).map((v) =>
//                     transformPoint(accumulatedMatrix, {
...
//               })
//             );
//             // console.log("solidVertices", solidVertices);
//             segments.push(...extractSegmentsFromVertices(solidVertices, true));
//             break;
...
//             console.log(
//               entity,
//               dxfData.blocks.find((b) => b.name === entity.block)
//             );
//             if (dxfData.blocks.find((b) => b.name === entity.block)) {
//               const block = dxfData.blocks.find((b) => b.name === entity.block);
//               const localTransform = {
//                 position: {
//                   x: entity.x || 0,
//                   y: entity.y || 0,
//                   z: entity.z || 0,
//                 },
//                 xScale: entity.scaleX || 1,
//                 yScale: entity.scaleY || 1,
//                 zScale: entity.scaleZ || 1,
//                 rotation: entity.rotation || 0,
//                 extrusion: entity.extrusion || { x: 0, y: 0, z: 1 },
//                 basePoint: { x: block.x, y: block.y, z: block.z },
//               };
