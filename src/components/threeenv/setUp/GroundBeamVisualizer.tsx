...
const GroundBeamVisualizer = observer(() => {
  ...
  return (
    <>
      ...
      />
      <DimensionLine
        startPoint={wallStore.internalWallPoints[1] as [number, number, number]}
        endPoint={wallStore.internalWallPoints[2] as [number, number, number]}
      ...
      <DimensionLine
        startPoint={wallStore.externalWallPoints[1] as [number, number, number]}
        endPoint={wallStore.externalWallPoints[2] as [number, number, number]}
        length={wallStore.innerWidth}
        lineDirection="+x"
        lineOffset={5}
        textDirection="+x"
