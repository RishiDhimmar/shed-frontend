...
export const BaseplateInput = () => {
  return (
    <div className="flex flex-col gap-4 overflow-y-scroll h-[calc(100vh-100px)] px-4">
      ...
      <div className="flex-col gap-4">
        <h1 className="text-2xl font-bold mb-6 text-center">Corner Baseplate</h1>
        <BaseplateDimensions type="corner" />
      </div>
      <div className="flex-col gap-4">
        <h1 className="text-2xl font-bold mb-6 text-center">Horizontal Baseplate</h1>
        <BaseplateDimensions type="horizontal" />
      </div>
      <div className="flex-col gap-4">
        <h1 className="text-2xl font-bold mb-6 text-center">Vertical Baseplate</h1>
