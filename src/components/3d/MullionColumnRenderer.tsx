...
const MullionColumnRenderer = observer(({ centerOffset, scale, camera, renderer }) => {
          ...
          if (nextPoints.length === 4) {
            ...
            if (shutterFlag && directionX > 0) {
              ...
              windowInstances.push({
                ...
                position: [
                  windowX,
                  configStore.shed3D.heights.PLINTH - 0.15 / 2 + shutterHeight / 2,
                  windowZ,
                ],
                rotation: [
      ...
      {windowInstances.map((window, index) => {
        ...
        return (
          ...
          >
            ...
            <lineSegments
              geometry={isShutter ? shutterEdgesGeometry : windowEdgesGeometry}
