    ...
    const {
      ...
      for (let i = 0; i < minPoints; i++) {
        ...
        const points = [
          {
            x:
              -(externalWallPoints[i].x / 1000 - centerOffset[0] ) ,
            z:
              -(externalWallPoints[i].y / 1000 - centerOffset[2]) ,
          },
          {
            x:
              -(externalWallPoints[j].x / 1000 - centerOffset[0]) ,
            z:
              -(externalWallPoints[j].y / 1000 - centerOffset[2]) ,
          },
          {
            x:
              -(internalWallPoints[i].x / 1000 - centerOffset[0]) ,
            z:
              -(internalWallPoints[i].y / 1000 - centerOffset[2]) ,
          },
          {
            x:
              -(internalWallPoints[j].x / 1000 - centerOffset[0]) ,
            z:
              -(internalWallPoints[j].y / 1000 - centerOffset[2]) ,
          },
        ];
