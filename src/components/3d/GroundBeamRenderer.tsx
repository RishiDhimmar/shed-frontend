...
const calculateBeams = (
  ...
  externalWallPoints = removeDuplicatePoints(
    externalWallPoints,
    configStore.precision
  );
  internalWallPoints = removeDuplicatePoints(
    internalWallPoints,
    configStore.precision
  );
  const ext = externalWallPoints.length;
  const int = internalWallPoints.length;
  console.log(
    "calculateBeams",
  ...
  const minPoints = Math.min(
    ext, // externalWallPoints.length,
    int //internalWallPoints.length
  );
