...
//       Object.entries(this.values).forEach(([, currentValues]) => {
//         const margin = 0.3;
...
//         let rect2Width = currentValues.RccBf;
//         let rect2Height = currentValues.rccLf;
...
class FoundationStore {
  ...
  generateFoundations() {
    ...
    columnStore.columns.forEach((column) => {
      ...
      // Select parameters based on the column type
      // Assuming column.wall is one of "corner", "horizontal", or "vertical"
